...
template <typename T>
class FourInRowMinMax_Player : public Player<T> {
public:
    FourInRowMinMax_Player(T symbol);
...
template <typename T>
FourInRowMinMax_Player<T>::FourInRowMinMax_Player(T symbol) : Player<T>(symbol) {
    this->name = "AI Player";
}

// Method to get the best move for the player
template <typename T>
void FourInRowMinMax_Player<T>::getmove(int& x, int& y) {
...
template <typename T>
int FourInRowMinMax_Player<T>::calculateMinMax(T s, bool isMaximizing) {
...
template <typename T>
std::pair<int, int> FourInRowMinMax_Player<T>::getBestMove() {
